...
const Hero = () => {
  return (
    <div className='pt-[120px] flex items-center justify-center relative  bg-primary bg-opacity-5 overflow-hidden'>
      ...
      <section className='container mt-6 flex items-center'>
        <div className='flex-grow '>
          <div className='flex flex-col items-center justify-center lg:items-start relative'>
            <span className='hero__subheading'>SIGN UP TODAY</span>
        ...
        <div className='max-w-[1055px] hidden lg:block relative'>
